...
### Заводите пояснительные переменные или функции
...
- Вместо покрытия кода комментариями пытайтесь отразить свои намерения в коде с помощью продуманного именования, введения пояснительных переменных и функций.
